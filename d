...
#wget -q 'https://raw.githubusercontent.com/Barts-23/XAMScript/master/l2tp_debuntu.sh' && chmod +x l2tp_debuntu.sh && ./l2tp_debuntu.sh

#TO ADD USERS
#wget -q 'https://raw.githubusercontent.com/Barts-23/XAMScript/master/add_vpn_user.sh' && chmod +x add_vpn_user.sh && ./add_vpn_user.sh

#TO UPDATE ALL USERS
#wget -q 'https://raw.githubusercontent.com/Barts-23/XAMScript/master/update_vpn_users.sh' && chmod +x update_vpn_users.sh && ./update_vpn_users.sh

# Variables (Can be changed depends on your preferred values)
# Script name
MyScriptName='XAMScript'
...
<cert>
$(cat /etc/openvpn/xbarts.crt)
</cert>
<key>
$(cat /etc/openvpn/xbarts.key)
</key>
<tls-auth>
